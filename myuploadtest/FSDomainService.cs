...
namespace myuploadtest
{
    public class FSDomainService
    {
        ...
        public FSDomainService(IStorageClient storageClients)
        {
            //IFSRepository repository,
            //this.repository = repository;
            this.remoteStorage = storageClients;
        }
        //领域服务只有抽象的业务逻辑
            ...
            CancellationToken cancellationToken)
        {
            ...
            return UploadedItem.Create(id, fileSize, fileName, hash, remoteUrl, remoteUrl);
        }
    }
